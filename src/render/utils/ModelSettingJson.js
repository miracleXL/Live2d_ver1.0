...
ModelSettingJson.prototype.getTextureFile = function (n) {
    if (this.json[this.TEXTURES] === undefined || this.json[this.TEXTURES][n] === undefined)
        return undefined;
...
ModelSettingJson.prototype.getHitAreaNum = function () {
    if (this.json[this.HIT_AREAS] === undefined)
        return 0;
...
ModelSettingJson.prototype.getHitAreaID = function (n) {
    if (this.json[this.HIT_AREAS] === undefined ||
        this.json[this.HIT_AREAS][n] === undefined)
        return undefined;
...
ModelSettingJson.prototype.getExpressionFile = function (n) {
    if (this.json[this.EXPRESSIONS] === undefined)
        return undefined;
...
ModelSettingJson.prototype.getMotions = function (name) {
    if (this.json[this.MOTION_GROUPS] === undefined)
        return undefined;
...
ModelSettingJson.prototype.getInitParamID = function (n) {
    if (this.json[this.INIT_PARAM] === undefined ||
        this.json[this.INIT_PARAM][n] === undefined)
        return undefined;
...
ModelSettingJson.prototype.getInitParamValue = function (n) {
    if (this.json[this.INIT_PARAM] === undefined || this.json[this.INIT_PARAM][n] === undefined)
        return NaN;
